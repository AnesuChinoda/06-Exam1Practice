...
def run_test_problem1a():
    ...
    print_expected_result_of_test([3, -9], expected, test_results,
                                  format_string)
    actual = problem1a(3, -9)
    print_actual_result_of_test(expected, actual, test_results)

    # Test 4:
    expected = 0.84147  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([5, 5], expected, test_results,
                                  format_string)
